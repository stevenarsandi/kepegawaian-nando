        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="col-11 mx-5 text-end">
                    <a class="btn bg-gradient-success" href="{{ route('cuticreate') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Data</a>
                </div>
                <div id="alert">
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Keterangan Cuti</th>
