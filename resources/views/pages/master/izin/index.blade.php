        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="col-11 mx-5 text-end">
                    <a class="btn bg-gradient-success" href="{{ route('izincreate') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Data</a>
                </div>
                <div id="alert">
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Divisi
                                    </th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Keterangan Izin</th>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-end">
                                        ...
                                        <button type="submit" class="btn btn-danger mx-1 btn-delete" data-toggle="modal" data-target="#deleteModal" data-id="{{ $item->id }}"><i
                                            ...
                                            <a class="btn btn-info text-dark px-3" href="{{ route('izinedit', ['id' => $item->id]) }}"><i
...
<script>
    $(document).ready(function () {
        $('.btn-delete').click(function () {
            ...
            $('#deleteForm').attr('action', '/izin/' + postId);
