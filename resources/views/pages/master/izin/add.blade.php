...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Tambah Izin'])
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form role="form" method="POST" action="{{ route('izin.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header pb-0">
                            <div class="text-start">
                                <h4>Tambah Data Izin</h4><hr>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="lama" placeholder="Masukkan Jumlah Hari Atau Jam Izin">
                                    </div>
                                    <div class="form-group">
