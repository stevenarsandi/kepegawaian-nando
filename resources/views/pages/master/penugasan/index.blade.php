...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Penugasan'])
    <div class="row mt-4 mx-4">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h2>Daftar Penugasan Karyawan</h2>
                </div>
                <div class="col-11 mx-5 text-end">
                    <a class="btn bg-gradient-success" href="{{ route('penugasancreate') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Data</a>
                </div>
                <div id="alert">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                            <form action="{{ route('penugasan') }}" method="GET" class="search-form">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-end">
                                        ...
                                        <button type="submit" class="btn btn-danger mx-1 btn-delete" data-toggle="modal" data-target="#deleteModal" data-id="{{ $item->id }}"><i
                                            ...
                                            <a class="btn btn-info text-dark px-3" href="{{ route('penugasanedit', ['id' => $item->id]) }}"><i
...
<script>
    $(document).ready(function () {
        $('.btn-delete').click(function () {
            ...
            $('#deleteForm').attr('action', '/penugasan/' + postId);
