...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Reward'])
    <div class="row mt-4 mx-4">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h2>Daftar Reward Karyawan</h2>
                </div>
                <div class="col-11 mx-5 text-end">
                    <a class="btn bg-gradient-success" href="{{ route('rewardcreate') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Data</a>
                </div>
                <div id="alert">
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Reward</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0 text-center">{{ $item->reward }}</p>
                                    </td>
                                    ...
                                    <td class="align-middle text-end">
                                        ...
                                        <button type="submit" class="btn btn-danger mx-1 btn-delete" data-toggle="modal" data-target="#deleteModal" data-id="{{ $item->id }}"><i
                                            ...
                                            <a class="btn btn-info text-dark px-3" href="{{ route('rewardedit', ['id' => $item->id]) }}"><i
...
<script>
    $(document).ready(function () {
        $('.btn-delete').click(function () {
            ...
            $('#deleteForm').attr('action', '/reward/' + postId);
